...
mathjax: true
image:
  path: /assets/images/typst-2560x1024-16zu9.png
  alt: "Typst Logo-Schriftzug"
header:
...
Da wäre zunächst einmal die Browser basierte Web App unter [https://typst.app/app](https://typst.app/app). Sie bietet auch ein Live Preview, so dass man direkt sieht, was man in der `.typ` Datei nebenan verzapft.
...
Ich habe mein bisher erstes und einziges Typst Dokument, was ich immer weiter schreibe und dabei Typst lerne, in [dieses Github Repository](https://github.com/metawops/typst) gelegt. Falls ihr mal schauen wollt.
...
### Release
Das ist mein "Release" Workflow, der immer dann zuschlägt, sobald ich in VSCode ein _tag_ vergebe **und** es eine neuere Version der Datei `CHANGELOG.md` gibt, damit ich auch brav Releasenotes pflege.
Es wird dann ein neues Release mit dem vergebenen _tag_ angelegt, welches sowohl die erzeugte PDF Datei enthält, als auch in Form einer ZIP Datei alle zum Erzeugen dieses PDFs notwendigen Quelldateien, also v.a. die `.typ` Dateien, aber auch die Fonts und Bilder in ihren jeweiligen Unterordnern.
