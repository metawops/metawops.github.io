...
tags:
  - typst
  - typesetting
excerpt: Meine ersten Erfahrungen mit Typst, insbesondere Programmierung und mit Typst Workflows in Github
mathjax: true
header:
  teaser: /assets/images/typst-2560x1024-16zu9.png
---
...
### Release
Ein "Release" Workflow, der immer dann zuschlägt, sobald ich in VSCode ein _tag_ vergebe **und** es eine neuere Version der Datei `CHANGELOG.md` gibt, damit ich auch brav Releasenotes pflege.
...
Dazu, was in Typst alles möglich ist – vor allem dann auch mit den [hunderten 3rd party Erweiterungspaketen](https://typst.app/universe/search/?kind=packages)! –, könnte man ganze Bücher schreiben. Und es gibt auch schon zahlreiche Tutorials und YouTube Videos von denen man prima lernen kann. Daher will ich in diesem Artikel gar nicht erst versuchen, eine Typst-Einführung zu geben.
