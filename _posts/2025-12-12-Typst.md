...
1. Ein "Release" Workflow, der immer dann zuschlägt, sobald ich in VSCode ein _tag_ vergebe **und** es eine neuere Version der Datei `CHANGELOG.md` gibt, damit ich auch brav Releasenotes pflege.
